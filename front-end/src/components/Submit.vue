<template>
    ...
    <section class="relative h-auto py-36">
        <img src="../assets/logis-base-logo.png" class="absolute w-40 transform -translate-x-1/2 left-1/2 top-11" alt="the-logisticom-logo">
        ...
        <p class='mt-3 mb-10 text-xl font-medium text-center text-error-900 '>You have successfully submitted! Here is the preview of your answers:</p>

        <div class="w-9/12 h-auto mx-auto overflow-y-scroll text-gray-800 py-14 rounded-3xl bg-form-bg">
